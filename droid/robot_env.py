...
class RobotEnv(gym.Env):
    def __init__(self, action_space="cartesian_velocity", gripper_action_space=None, control_hz=15, camera_kwargs={}, do_reset=True):
        ...
        if nuc_ip is None:
            ...
            self._robot = FrankaRobot(control_hz=control_hz)
        else:
